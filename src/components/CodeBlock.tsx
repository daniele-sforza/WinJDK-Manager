    ...
    <div className="w-full max-w-4xl mx-auto bg-zinc-950 rounded-xl overflow-hidden shadow-2xl border border-zinc-800">
      <div className="flex items-center justify-between px-4 py-3 bg-zinc-900 border-b border-zinc-800">
        ...
        <div className="flex space-x-2">
          <button
            onClick={handleCopy}
            className="flex items-center px-3 py-1.5 text-xs font-medium text-zinc-300 bg-zinc-800 rounded-md hover:bg-zinc-700 transition-colors"
          >
          ...
          <button
            ...
            className="flex items-center px-3 py-1.5 text-xs font-medium text-zinc-950 bg-emerald-400 rounded-md hover:bg-emerald-300 transition-colors"
          >
